...
// React Hooks позволяют вам сохранять ваши функциональные компоненты как функции и привязывать 
//состояние к специфическим функциям React. Вот и все. Такой простой, но такой мощный. 
...
//написан как функциональные компоненты с хуками. Существующий код следует переписывать только в том случае,
// если он часто изменяется (например, если ты исправляешь ошибку или добавляешь функциональность, 
//найди время, чтобы заменить компонент на хуки).
