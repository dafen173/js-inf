...
// Итак, смотрите. Я никак не могу узнать того, сколько руководств по стилизации в React вы уже просмотрели, хотя я предполагаю, что не так уж и много. А если вы вообще не видели какого-либо руководства по этой теме, то вы уже наверное задаётесь вопросом, что это это такое и как это лучше делать.

// Итак, мы тут для того, что узнать как стилизовать компоненты в React и когда вы закончите читать этот пост, вы точно будете знать то, как это правильно делать.
...
// Если вы новичок в React, то почитайте эту статью. Всё, что нужно знать, чтобы войти в React в 2018 году
...
// Итак, мы только что добавили инлайновые стили для внешних <div> и <h2>. Итак, вот несколько вещей, которые нужно знать по этому поводу.
...
// Если у вас есть один компонент и вы хотите создать такой же, но только немного по-другому стилизованный, вы можете использовать extend:
