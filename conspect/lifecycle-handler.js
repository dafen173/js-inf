...
// Когда вы определяете компонент, используя ES6-класс, общий паттерн таков: обработчик события должен 
//быть методом класса. 

// componentWillUnmount
// Используйте эту функцию для «очистки» после компонента, если он использует 
//таймеры (setTimeout, setInterval), открывает сокеты или производит любые операции, которые 
