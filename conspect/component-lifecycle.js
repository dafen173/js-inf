...
// мы делаем различного чистку отписываемся от слушателей события очищаем глобальное
...
//один хук следить за одними данными 
...
// React предоставляет несколько методов, уведомляющих нас о происходящих процессах. Эти методы называются методами жизненного цикла компонента. Они вызываются в определенном порядке. Жизненный цикл компонента делится на 3 стадии.
