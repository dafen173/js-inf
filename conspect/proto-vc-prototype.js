...
// prototype - это свойство функции-КОНСТРУКТОРА. В этом свойстве находится ссылка на объект, 
//являющийся прототипом всех объектов данного класса.

// Ссылку на этот объект конструктор пропишет в свойство _proto_ создаваемого объекта, 
//когда вызовет функцию Object.create. Первым параметром ей как-раз передаётся ссылка на прототип 
